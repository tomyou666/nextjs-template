...
```tsx
// src/app/components/ToastButtonSample.tsx
'use client'
...
```tsx
// src/app/dashboard/error/AlertButtonSample.tsx
'use client'
...
```tsx
// src/app/dashboard/error/ErrorButtonSample.tsx
'use client'
...
アプリケーションでは、ロギング設定を一元管理するために`src/lib/share/constants.ts`ファイルで定数を定義しています：
