...
export function Toast({
	...
	return (
		...
		>
			...
			{action}
			<ToastPrimitives.Close className="absolute top-1 right-1 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-hidden focus:ring-1 group-hover:opacity-100">
				<X className="h-4 w-4" />
