import { BarChartSample } from '@/app/dashboard/BarChartSample'
import { RecentSales } from '@/app/dashboard/RecentSales'
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						...
						<svg
							...
							aria-labelledby="revenue-icon"
							role="img"
						>
							<title id="revenue-icon">Revenue Icon</title>
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						...
						<svg
							...
							strokeWidth="2"
							className="h-4 w-4 text-muted-foreground"
							aria-labelledby="subscriptions-icon"
							role="img"
						>
							<title id="subscriptions-icon">Subscriptions Icon</title>
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						...
						<svg
							...
							strokeWidth="2"
							className="h-4 w-4 text-muted-foreground"
							aria-labelledby="sales-icon"
							role="img"
						>
							<title id="sales-icon">Sales Icon</title>
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						...
						<svg
							...
							strokeWidth="2"
							className="h-4 w-4 text-muted-foreground"
							aria-labelledby="active-now-icon"
							role="img"
						>
							<title id="active-now-icon">Active Now Icon</title>
